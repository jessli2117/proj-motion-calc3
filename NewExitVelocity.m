...
plot(y,z);
title("New-Material Bat Exit Velocity Best Home Run");
xlabel("Distance (ft)");
ylabel("Height (ft)");
hold on
...
gradient(k);
hold off
legend("Amount over Fence: 270.53ft.","Tangent Vector","Normal Vector");
TangentVector = [-0.5454 -0.4397];
NormalVector = [-0.4397 -0.8981];
Curvature = 0.0043;
